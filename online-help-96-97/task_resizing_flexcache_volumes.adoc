...
[NOTE]
====
Si desea expandir el volumen de FlexCache añadiendo nuevos recursos, haga clic en image:../media/advanced_options.gif[""] (opciones avanzadas). Consulte link:task_specifying_advanced_options_for_flexcache_volume.md#GUID-021C533F-BBA1-41A9-A191-DE223A158B4B["Especificar las opciones avanzadas para FlexCache Volumes"].
