...
[role="lead"]
Puede utilizar SVM con ONTAP System Manager Classic (disponible en ONTAP 9.7 y versiones anteriores) para proporcionar acceso a los datos a los clientes independientemente del almacenamiento físico o de la controladora, de forma similar a cualquier sistema de almacenamiento. Los SVM proporcionan ventajas como operaciones no disruptivas, escalabilidad, seguridad y almacenamiento unificado.
