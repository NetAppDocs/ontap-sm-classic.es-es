...
... Si no desea usar el valor predeterminado, especifique un nuevo valor de destino. Si no existe ninguna ruta, se creará una nueva de forma automática en función de la puerta de enlace y el destino.
