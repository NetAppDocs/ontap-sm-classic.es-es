...
. *Opcional:* haga clic image:../media/advanced_options.gif[""] Para modificar la configuración de volúmenes FlexGroup. Consulte link:task_specifying_advanced_options_for_flexgroup_volume.md#GUID-021C533F-BBA1-41A9-A191-DE223A158B4B["Especificar las opciones avanzadas para un volumen de FlexGroup"].
...
[NOTE]
====
Si desea expandir el volumen de FlexGroup añadiendo nuevos recursos, haga clic en image:../media/advanced_options.gif[""] (opciones avanzadas). Consulte link:task_specifying_advanced_options_for_flexgroup_volume.md#GUID-021C533F-BBA1-41A9-A191-DE223A158B4B["Especificar las opciones avanzadas para un volumen de FlexGroup"].
