...
** Si el SP utiliza la configuración de red automática, compruebe que la subred que utiliza el SP tenga direcciones IP disponibles para los dos nodos nuevos mediante el `network subnet show` comando. En la siguiente salida, la subred sub1 tiene 2 direcciones disponibles:
